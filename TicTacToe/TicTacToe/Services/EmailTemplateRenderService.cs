...
namespace TicTacToe.Services
{
    public class EmailTemplateRenderService : IEmailTemplateRenderService
    {
        ...
        public EmailTemplateRenderService(IWebHostEnvironment webHostEnvironment, IConfiguration configuration, IHttpContextAccessor httpContextAccessor)
        {
        ...
        {
            var html = await new EmailViewRenderHelper().RenderTemplate(templateName, _webHostingEnvironment,
