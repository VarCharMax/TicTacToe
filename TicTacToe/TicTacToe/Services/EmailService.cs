    ...
    public class EmailService : IEmailService
    {
        ...
        public Task SendEmail(string emailTo, string subject, string message)
        {
            try
            {
                ...
                {
                    if (bool.Parse(_emailServiceOptions.UseSSL)) client.EnableSsl = true;
                    if (!string.IsNullOrEmpty(_emailServiceOptions.UserId)) client.Credentials = new NetworkCredential(_emailServiceOptions.UserId, _emailServiceOptions.Password);
