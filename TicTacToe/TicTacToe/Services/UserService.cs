...
namespace TicTacToe.Services
{
    public class UserService : IUserService
    {
        ...
        {
            _logger.LogTrace($"Sign in user {loginModel.UserName}");
            ...
            {
                _logger.LogError($"Cannot sign in user {loginModel.UserName} - {ex}");
            ...
            {
                stopWatch.Stop();
                _logger.LogTrace($"Sign in user {loginModel.UserName} in {stopWatch.Elapsed}");
            }
        }
        ...
        public async Task<ExternalLoginInfo> GetExternaLoginInfoAsync()
        {
        ...
        {
            return await _userManager.Users.Take(numberOfUsers).OrderBy(x => x.Score).ToListAsync();
        }
